...
<h2><?php  echo __('Group');?></h2>
	<dl>
		...
		<dd>
			<?php echo h($group['Group']['create_at']); ?>
			&nbsp;
		</dd>
		...
		<dd>
			<?php echo h($group['Group']['modify_at']); ?>
			&nbsp;
		</dd>
		...
		<dd>
			<?php echo h($group['Group']['delete_at']); ?>
			&nbsp;
		</dd>
...
<div class="related">
	...
	<tr>
		...
		<th><?php echo __('Modify At'); ?></th>
		<th><?php echo __('Deleted'); ?></th>
		<th><?php echo __('Delete At'); ?></th>
